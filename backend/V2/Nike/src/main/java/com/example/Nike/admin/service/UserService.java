...
return  null ;
    ...
    public void sendEmail(String recipientEmail)
        ...
        resetTokenService.generateResetTokenForUser(recipientEmail ,  token) ;
        ...
        String content = "<div style='font-family: Arial, sans-serif; color: #333; padding: 20px; background-color: #f9f9f9;'>"
                + "<h1 style='text-align: center;'><img src='https://i.imgur.com/NUvGAJQ.png' alt='Nike' style='max-width: 100px;'></h1>"
